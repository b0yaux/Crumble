...
s1.path = "superstratum_video-data:1"

local s2 = addNode("AVSampler", "s2")
s2.path = "superstratum_video-data:6"
...
-- s1.speed = scale(0.01, 0.6, osc(0.2))
 s1.speed = shift(0.7, seq("1 -0.9 1.2 -0.5")) -- Offset phase of a sequence
-- s1.speed = fast(5, noise(1))            -- Very slow stochastic speed drift
-- s1.speed = 0.1
-- s2 speed: A quantized (snapped) sequence running at double time
 s2.speed = shift(2, seq("1 0.5")) -- 4-step staircase speed ramp
